...
import com.example.msareefapp.Ui.Fragments.Inovice.PurchasedItemAdapter
import com.example.msareefapp.databinding.InvoiceItemBinding

class InvoicesAdapter(private val items : MutableList<Invoice?>?) :BaseAdapter <Invoice, InvoiceItemBinding>(items) {
